...
LOG_FILE = os.path.join(BASE_DIR, "ai_performance_log_v5.json")
...
@app.post("/direct_modify")
def direct_modify():
    """Allow external modification requests."""
    try:
        response = requests.post("http://127.0.0.1:8001/modify_code", json={
            "filename": "AI_System.py",
            "modification": "# AI direct modification test!"
        })
